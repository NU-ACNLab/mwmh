...
def postproc_rest_space_anat(sub, ses, funcindir, bidssesdir, sesoutdir):
    ...
    rest_cen2.to_filename(sesoutdir+'/'+sub+'_'+ses+'space-T1w_task-rest_final.nii.gz')
    ...
    rest_qual_df.to_csv(sesoutdir+'/'+sub+'_'+ses+'_space-T1w_task-rest_quality.csv', index=False)
