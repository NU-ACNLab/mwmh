...
#SBATCH --mem-per-cpu=120G                                ## how much RAM do you need per CPU (this effects your FairShare score so be careful to not ask for more than you need))
...
Rscript /projects/b1108/studies/mwmh/scripts/process/template_Yeo17_MWMH_sub-all_ses-2_task-all.R

#sbatch -o /projects/b1108/studies/mwmh/data/processed/neuroimaging/launch/template_Yeo17/MWMH_sub-all_ses-2_task-all.txt /projects/b1108/studies/mwmh/scripts/process/launch_estimate_template_sub-all_ses-2_task-all.sh