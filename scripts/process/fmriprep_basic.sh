...
#SBATCH --job-name="fmriprep_test_run"                    ## use the task id in the name of the job
...
#sbatch -o /projects/b1108/studies/mwmh/launch/fmriprep/test.txt /projects/b1108/studies/mwmh/scripts/process/fmriprep_basic.sh
