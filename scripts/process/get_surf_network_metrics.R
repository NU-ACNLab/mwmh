...
neuro_dir <- '/projects/b1108/studies/mwmh/data/processed/neuroimaging/'
template_obj <- readRDS(paste0(neuro_dir, 'template_Yeo17/temp.rds'))
...
# Move NA and 0 to the medial wall
rest_cifti <- move_to_mwall(rest_cifti, values = c(NA, 0))
...
networks_img <- templateICA(rest_cifti, template_obj, tvar_method = 'unbiased', 
            scale = 'local', TR = 0.555, scale_sm_FWHM = 2) #not working... want this one
