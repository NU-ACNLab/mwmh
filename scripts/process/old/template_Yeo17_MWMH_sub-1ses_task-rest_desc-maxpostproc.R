...
save(list=ls(), file=paste0(outdir, 'template_Yeo17_MWMH_sub-1ses_task-rest_desc-maxpostproc_args.rda'))

temp_subjs <- read.csv(paste0(indir, 'tabulated/temp_subjs_sub-1ses_task-rest_desc-maxpostproc.csv'))
...
saveRDS(temp, paste0(outdir, 'temp_sub-1ses_task-rest_desc-maxpostproc.rds'))


#plot(temp, idx=1:17, fname=paste0('/Users/flutist4129/Documents/Northwestern/studies/mwmh/plots/temp_maxpostproc_sub-1ses_', 1:17))