...
#sbatch -o /projects/b1108/studies/mwmh/data/processed/neuroimaging/launch/template/MWMH_sub-all_ses-2_task-all.txt /projects/b1108/studies/mwmh/scripts/process/launch_estimate_template_sub-all_ses-2_task-all.sh