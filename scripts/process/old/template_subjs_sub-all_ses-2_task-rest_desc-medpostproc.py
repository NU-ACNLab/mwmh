### This script identifies individuals who have medium processed 
...
temp_subjs_df.to_csv(outdir + 'temp_subjs_sub-all_ses-2_task-rest_desc-medpostproc.csv', index = False)
