...
Rscript /projects/b1108/studies/mwmh/scripts/process/template_Yeo17_MWMH_sub-1ses_task-rest_desc-maxpostproc.R

#sbatch -o /projects/b1108/studies/mwmh/data/processed/neuroimaging/launch/template/MWMH_sub-1ses_task-rest_desc-maxpostproc.txt /projects/b1108/studies/mwmh/scripts/process/launch_estimate_template_sub-1ses_task-rest_desc-maxpostproc.sh