...
#SBATCH --job-name="manually_curate"                      ## use the task id in the name of the job
...
python3 /projects/b1108/studies/mwmh/scripts/curation/manually_curate.py


# sbatch -o /projects/b1108/studies/mwmh/data/raw/neuroimaging/launch/bids/curate.txt \
# /projects/b1108/studies/mwmh/scripts/curation/launch_manually_curate.sh
