...
param_df.to_csv('/projects/b1108/studies/mwmh/data/raw/meta/params.csv', index=False)
...
unique_param_df = param_df.drop('subid', 1).drop('sesid', 1).drop('AcquisitionDate', 1).drop('AcquisitionTime', 1).drop_duplicates()
unique_param_df.to_csv('/projects/b1108/studies/mwmh/data/raw/meta/unique_params.csv',index=False)
