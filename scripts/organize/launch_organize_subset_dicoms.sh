...
#SBATCH --job-name="organizesubset"                       ## use the task id in the name of the job
...
# sbatch -o /projects/b1108/studies/mwmh/errors/launch_organize_subset_dicoms.txt \
# /projects/b1108/studies/mwmh/scripts/organize/launch_organize_subset_dicoms.sh
